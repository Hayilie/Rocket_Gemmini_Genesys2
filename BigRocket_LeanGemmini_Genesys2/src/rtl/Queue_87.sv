...
module Queue_87(
  ...
  input  [31:0] io_enq_bits_data_0_0,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                ...
                io_enq_bits_data_8_0,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                io_enq_bits_data_9_0,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                io_enq_bits_data_10_0,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                io_enq_bits_data_11_0,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                io_enq_bits_data_12_0,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                io_enq_bits_data_13_0,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                io_enq_bits_data_14_0,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                io_enq_bits_data_15_0,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                io_enq_bits_scale_bits,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  output [31:0] io_deq_bits_data_0_0,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                ...
                io_deq_bits_data_8_0,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                io_deq_bits_data_9_0,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                io_deq_bits_data_10_0,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                io_deq_bits_data_11_0,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                io_deq_bits_data_12_0,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                io_deq_bits_data_13_0,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                io_deq_bits_data_14_0,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                io_deq_bits_data_15_0,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  reg  [677:0] ram;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  always @(posedge clock) begin
    if (do_enq)	// @[src/main/scala/chisel3/util/Decoupled.scala:281:27, :316:17, :319:{26,35}]
      ram <= {2'h0, io_enq_bits_act, io_enq_bits_iexp_qln2_inv, io_enq_bits_iexp_qln2, io_enq_bits_igelu_qc, io_enq_bits_igelu_qb, io_enq_bits_scale_bits, 1'h1, io_enq_bits_data_15_0, io_enq_bits_data_14_0, io_enq_bits_data_13_0, io_enq_bits_data_12_0, io_enq_bits_data_11_0, io_enq_bits_data_10_0, io_enq_bits_data_9_0, io_enq_bits_data_8_0, io_enq_bits_data_7_0, io_enq_bits_data_6_0, io_enq_bits_data_5_0, io_enq_bits_data_4_0, io_enq_bits_data_3_0, io_enq_bits_data_2_0, io_enq_bits_data_1_0, io_enq_bits_data_0_0};	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95]
    if (reset)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[5'h0][31:1], _RANDOM[5'h1], _RANDOM[5'h2], _RANDOM[5'h3], _RANDOM[5'h4], _RANDOM[5'h5], _RANDOM[5'h6], _RANDOM[5'h7], _RANDOM[5'h8], _RANDOM[5'h9], _RANDOM[5'hA], _RANDOM[5'hB], _RANDOM[5'hC], _RANDOM[5'hD], _RANDOM[5'hE], _RANDOM[5'hF], _RANDOM[5'h10], _RANDOM[5'h11], _RANDOM[5'h12], _RANDOM[5'h13], _RANDOM[5'h14], _RANDOM[5'h15][6:0]};	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  assign io_deq_bits_data_8_0 = full ? ram[287:256] : io_enq_bits_data_8_0;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_data_9_0 = full ? ram[319:288] : io_enq_bits_data_9_0;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_data_10_0 = full ? ram[351:320] : io_enq_bits_data_10_0;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_data_11_0 = full ? ram[383:352] : io_enq_bits_data_11_0;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_data_12_0 = full ? ram[415:384] : io_enq_bits_data_12_0;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_data_13_0 = full ? ram[447:416] : io_enq_bits_data_13_0;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_data_14_0 = full ? ram[479:448] : io_enq_bits_data_14_0;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_data_15_0 = full ? ram[511:480] : io_enq_bits_data_15_0;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_fromDMA = ~full | ram[512];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :279:28, :311:17, :316:17, :317:19]
  assign io_deq_bits_scale_bits = full ? ram[544:513] : io_enq_bits_scale_bits;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_igelu_qb = full ? ram[576:545] : io_enq_bits_igelu_qb;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_igelu_qc = full ? ram[608:577] : io_enq_bits_igelu_qc;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_iexp_qln2 = full ? ram[640:609] : io_enq_bits_iexp_qln2;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_iexp_qln2_inv = full ? ram[672:641] : io_enq_bits_iexp_qln2_inv;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_act = full ? ram[675:673] : io_enq_bits_act;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
