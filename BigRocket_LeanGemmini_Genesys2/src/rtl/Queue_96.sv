...
module Queue_96(
  ...
  wire [7:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  ram_6x8 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_total_rows, io_enq_bits_id})	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  );
  ...
  assign io_deq_bits_id = _ram_ext_R0_data[2:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_total_rows = _ram_ext_R0_data[7:3];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
