...
module ICache(
  ...
  wire             readEnable_1;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:582:46]
  wire             writeEnable_1;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:562:32]
  wire             readEnable_2;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:582:46]
  wire             writeEnable_2;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:562:32]
  wire             readEnable_3;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:418:83]
  ...
  wire [31:0]      _data_arrays_3_0_RW0_rdata;	// @[generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26]
  wire [31:0]      _data_arrays_2_0_RW0_rdata;	// @[generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26]
  ...
  wire             writeEnable_3 = refill_one_beat & (counter == 8'h1 | beats1 == 8'h0) & auto_master_out_d_valid;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:383:39, :391:37, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:222:14, :230:27, :233:{25,33,43}]
  assign _tag_rdata_T_4 = io_req_bits_addr[11:6];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:418:42]
  assign readEnable_3 = ~writeEnable_3 & s0_valid;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:391:37, :418:{70,83}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
  ...
  assign writeEnable_2 = refill_one_beat & ~invalidated;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:359:24, :383:39, :562:{32,35}]
  wire [7:0]       _mem_idx_T_18 = {refill_paddr[11:6], 2'h0};	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:378:31, :556:111, :566:40, :851:21]
  assign readEnable_2 = ~writeEnable_2 & s0_valid & io_req_bits_addr[3:2] == 2'h0;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:556:111, :562:32, :582:{41,46}, generators/rocket-chip/src/main/scala/util/package.scala:155:13, src/main/scala/chisel3/util/Decoupled.scala:52:35]
  assign writeEnable_1 = refill_one_beat & ~invalidated;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:359:24, :383:39, :562:{32,35}]
  assign readEnable_1 = ~writeEnable_2 & s0_valid & io_req_bits_addr[3:2] == 2'h1;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:556:111, :562:32, :582:{41,46}, generators/rocket-chip/src/main/scala/util/package.scala:155:13, src/main/scala/chisel3/util/Decoupled.scala:52:35]
  ...
  assign readEnable_0 = ~writeEnable_2 & s0_valid & io_req_bits_addr[3:2] == 2'h2;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:556:111, :562:32, :582:{41,46}, generators/rocket-chip/src/main/scala/util/package.scala:155:13, src/main/scala/chisel3/util/Decoupled.scala:52:35]
  ...
  assign readEnable = ~writeEnable_2 & s0_valid & (&(io_req_bits_addr[3:2]));	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:556:111, :562:32, :582:{41,46}, generators/rocket-chip/src/main/scala/util/package.scala:155:13, src/main/scala/chisel3/util/Decoupled.scala:52:35]
  ...
  wire [3:0][31:0] _GEN = {{_data_arrays_3_0_RW0_rdata}, {_data_arrays_2_0_RW0_rdata}, {_data_arrays_1_0_RW0_rdata}, {_data_arrays_0_0_RW0_rdata}};	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:556:111, :584:71, :585:15, generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      refill_valid <= ~writeEnable_3 & (auto_master_out_a_ready & masterNodeOut_a_valid | refill_valid);	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:360:29, :377:35, :391:37, :822:{22,37}, :823:{22,37}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      ...
      if (io_invalidate)	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:248:14]
        ...
        vb_array <= writeEnable_3 & ~invalidated ? vb_array | _vb_array_T_3[63:0] : ~(~vb_array | _vb_array_T_3[63:0]);	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:359:24, :391:37, :440:25, :444:{32,72,75}]
    end
    ...
    if (s1_valid) begin	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:333:25]
      s2_dout_0 <= _GEN[io_s1_paddr[3:2]];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:556:111, :584:71, :585:15, :604:26, generators/rocket-chip/src/main/scala/util/package.scala:155:13]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s2_valid = _RANDOM[4'h1][12];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:355:25]
        s2_hit = _RANDOM[4'h1][13];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:355:25, :356:23]
        invalidated = _RANDOM[4'h1][14];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:355:25, :359:24]
        refill_valid = _RANDOM[4'h1][15];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:355:25, :360:29]
        s2_request_refill_REG = _RANDOM[4'h1][18];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:355:25, :377:45]
        refill_paddr = {_RANDOM[4'h1][31:19], _RANDOM[4'h2][18:0]};	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:355:25, :378:31]
        counter = {_RANDOM[4'h3][31:26], _RANDOM[4'h4][1:0]};	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:230:27]
        accruedRefillError = _RANDOM[4'h4][2];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:420:31, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:230:27]
        vb_array = {_RANDOM[4'h4][31:3], _RANDOM[4'h5], _RANDOM[4'h6][2:0]};	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:440:25, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:230:27]
        s2_dout_0 = {_RANDOM[4'h7][31:16], _RANDOM[4'h8][15:0]};	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:604:26]
        s2_tl_error = _RANDOM[4'h8][17];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:604:26, :607:30]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  tag_array_0_0 tag_array_0 (	// @[generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26]
    .RW0_addr  (writeEnable_3 ? refill_paddr[11:6] : _tag_rdata_T_4),	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:378:31, :391:37, :418:42, :851:21, generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26]
    .RW0_en    (readEnable_3 | writeEnable_3),	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:391:37, :418:83, generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26]
    .RW0_clk   (clock),
    .RW0_wmode (writeEnable_3),	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:391:37]
  ...
  data_arrays_0_0 data_arrays_0_0 (	// @[generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26]
    ...
    .RW0_en    (readEnable_2 | writeEnable_2),	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:562:32, :582:46, generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26]
    .RW0_clk   (clock),
    .RW0_wmode (writeEnable_2),	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:562:32]
  ...
  data_arrays_1_0 data_arrays_1_0 (	// @[generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26]
    .RW0_addr  (refill_one_beat ? _mem_idx_T_18 | refill_cnt : io_req_bits_addr[11:4]),	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:383:39, :557:31, :566:{10,40,67}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:235:25]
    .RW0_en    (readEnable_1 | writeEnable_1),	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:562:32, :582:46, generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26]
    .RW0_clk   (clock),
    .RW0_wmode (writeEnable_2),	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:562:32]
  ...
  data_arrays_2_0 data_arrays_2_0 (	// @[generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26]
    .RW0_addr  (refill_one_beat ? _mem_idx_T_18 | refill_cnt : io_req_bits_addr[11:4]),	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:383:39, :557:31, :566:{10,40,67}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:235:25]
    ...
    .RW0_clk   (clock),
    .RW0_wmode (writeEnable_2),	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:562:32]
    .RW0_wdata (auto_master_out_d_bits_data[95:64]),	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:575:71]
    .RW0_rdata (_data_arrays_2_0_RW0_rdata)
  );
  data_arrays_3_0 data_arrays_3_0 (	// @[generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26]
    .RW0_addr  (refill_one_beat ? _mem_idx_T_18 | refill_cnt : io_req_bits_addr[11:4]),	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:383:39, :557:31, :566:{10,40,67}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:235:25]
    ...
    .RW0_clk   (clock),
    .RW0_wmode (writeEnable_2),	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:562:32]
    .RW0_wdata (auto_master_out_d_bits_data[127:96]),	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:575:71]
    .RW0_rdata (_data_arrays_3_0_RW0_rdata)
  );
