...
module LoopMatmulLdD(
  ...
  wire [27:0] _dram_offset_T_5 = {12'h0, i} * req_dram_stride[27:0];	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:272:16, :278:14, :282:{39,57}]
  wire [28:0] _sp_addr_T_4 = {19'h0, req_addr_start} + {{9'h0, i} * {9'h0, req_max_j} + {9'h0, j}, 4'h0};	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:272:16, :277:14, :278:14, :285:{32,37,49}, :287:43, :296:16]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_pad_j = _RANDOM[3'h1][4:1];	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:272:16]
        req_pad_i = _RANDOM[3'h1][8:5];	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:272:16]
        req_dram_addr = {_RANDOM[3'h1][31:9], _RANDOM[3'h2][16:0]};	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:272:16]
        req_dram_stride = {_RANDOM[3'h2][31:17], _RANDOM[3'h3][24:0]};	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:272:16]
        req_low_d = _RANDOM[3'h3][25];	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:272:16]
        req_addr_start = {_RANDOM[3'h3][31:26], _RANDOM[3'h4][3:0]};	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:272:16]
        req_loop_id = _RANDOM[3'h4][4];	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:272:16]
        j = _RANDOM[3'h4][20:5];	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:272:16, :277:14]
        i = {_RANDOM[3'h4][31:21], _RANDOM[3'h5][4:0]};	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:272:16, :278:14]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_cmd_bits_rs1 = {23'h0, {9'h0, req_low_d ? {_dram_offset_T_5 + {12'h0, j}, 4'h0} : {_dram_offset_T_5[25:0] + {10'h0, j}, 6'h0}} + {1'h0, req_dram_addr}};	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:270:22, :272:16, :277:14, :282:{24,39,57}, :283:{26,46}, :284:33, :287:43, :296:16, :1139:17]
  assign io_cmd_bits_rs2 = {11'h0, 5'h10 - {1'h0, i == _next_i_max_T ? req_pad_i : 4'h0}, 9'h0, {blocks[2:0], 4'h0} - {3'h0, j + blocks >= req_max_j ? req_pad_j : 4'h0}, 3'h4, _sp_addr_T_4[28:26], 11'h0, _sp_addr_T_4[14:0]};	// @[generators/gemmini/src/main/scala/gemmini/LocalAddr.scala:108:37, generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:270:22, :272:16, :277:14, :278:14, :285:32, :286:19, :287:{38,43,46,55}, :288:{27,32,35,48}, :296:16, :300:32]
