...
module Frontend(
  ...
  wire [39:0] predicted_npc = {s1_pc[39:2], 2'h0} + 40'h4;	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:111:18, :125:25, :152:49]
  ...
  assign _io_cpu_npc_T = io_cpu_req_valid ? io_cpu_req_bits_pc[39:1] : s2_replay ? s2_pc[39:1] : predicted_npc[39:1];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:81:14, :113:22, :125:25, :130:46, :131:16, :182:28]
  ...
  always @(posedge clock) begin
    ...
    s1_pc <= {_io_cpu_npc_T, 1'h0};	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18, generators/rocket-chip/src/main/scala/rocket/Frontend.scala:66:26, :81:14, :87:64, :101:19, :111:18, :182:28, :377:33]
    ...
    if (reset) begin
      s2_valid <= 1'h0;	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18, generators/rocket-chip/src/main/scala/rocket/Frontend.scala:66:26, :81:14, :87:64, :101:19, :104:25]
      s2_pc <= 40'h10000;	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:113:22]
      s2_speculative <= 1'h0;	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18, generators/rocket-chip/src/main/scala/rocket/Frontend.scala:66:26, :81:14, :87:64, :101:19, :119:31]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s2_tlb_resp_miss = _RANDOM[3'h4][11];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:117:24]
        s2_tlb_resp_pf_inst = _RANDOM[3'h6][23];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:117:24]
        s2_tlb_resp_ae_inst = _RANDOM[3'h6][29];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:117:24]
        s2_tlb_resp_cacheable = _RANDOM[3'h7][1];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:117:24]
        s2_speculative = _RANDOM[3'h7][4];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:117:24, :119:31]
        s2_replay_REG = _RANDOM[3'h7][23];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:117:24, :130:56]
        recent_progress_counter = _RANDOM[3'h7][25:24];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:117:24, :151:40]
        fq_io_enq_valid_REG = _RANDOM[3'h7][26];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:117:24, :180:29]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ICache icache (	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:66:26]
    ...
    .io_req_bits_addr               ({_io_cpu_npc_T[37:0], 1'h0}),	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18, generators/rocket-chip/src/main/scala/rocket/Frontend.scala:66:26, :81:14, :87:64, :101:19, :170:27, :182:28]
    .io_s1_paddr                    (_tlb_io_resp_paddr),	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:101:19]
    .io_s1_kill                     (io_cpu_req_valid | _tlb_io_resp_miss | s2_replay),	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:101:19, :130:46, :174:56]
  ...
  ShiftQueue fq (	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:87:64]
    ...
    .io_enq_bits_replay       (_icache_io_s2_kill_T_2 & ~_icache_io_resp_valid & ~_s2_xcpt_T | _fq_io_enq_bits_replay_T_5),	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:66:26, :118:37, :176:71, :180:112, :186:{80,102,105,115}]
