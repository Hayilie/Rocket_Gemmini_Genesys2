...
module MSHR(
  ...
  wire        req_clientBit = request_source == 9'h180;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:98:20, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:46:9]
  ...
  wire        new_clientBit = (io_allocate_valid ? io_allocate_bits_source : request_source) == 9'h180;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:98:20, :506:24, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:46:9]
  ...
  wire        probe_bit = io_sinkc_bits_source == 9'h180;	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:46:9]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        request_tag = {_RANDOM[2'h0][31:23], _RANDOM[2'h1][3:0]};	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:97:30, :98:20]
        request_offset = _RANDOM[2'h1][9:4];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:98:20]
        request_put = _RANDOM[2'h1][15:10];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:98:20]
        request_set = _RANDOM[2'h1][25:16];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:98:20]
        ...
        meta_tag = {_RANDOM[2'h1][31], _RANDOM[2'h2][11:0]};	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:98:20, :100:17]
        meta_hit = _RANDOM[2'h2][12];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:100:17]
        meta_way = _RANDOM[2'h2][15:13];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:100:17]
        s_rprobe = _RANDOM[2'h2][16];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:100:17, :121:33]
        w_rprobeackfirst = _RANDOM[2'h2][17];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:100:17, :122:33]
        w_rprobeacklast = _RANDOM[2'h2][18];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:100:17, :123:33]
        s_release = _RANDOM[2'h2][19];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:100:17, :124:33]
        w_releaseack = _RANDOM[2'h2][20];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:100:17, :125:33]
        s_pprobe = _RANDOM[2'h2][21];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:100:17, :126:33]
        s_acquire = _RANDOM[2'h2][22];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:100:17, :127:33]
        s_flush = _RANDOM[2'h2][23];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:100:17, :128:33]
        w_grantfirst = _RANDOM[2'h2][24];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:100:17, :129:33]
        w_grantlast = _RANDOM[2'h2][25];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:100:17, :130:33]
        w_grant = _RANDOM[2'h2][26];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:100:17, :131:33]
        w_pprobeackfirst = _RANDOM[2'h2][27];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:100:17, :132:33]
        w_pprobeacklast = _RANDOM[2'h2][28];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:100:17, :133:33]
        w_pprobeack = _RANDOM[2'h2][29];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:100:17, :134:33]
        s_grantack = _RANDOM[2'h2][31];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:100:17, :136:33]
        s_execute = _RANDOM[2'h3][0];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:137:33]
        w_grantack = _RANDOM[2'h3][1];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:137:33, :138:33]
        s_writeback = _RANDOM[2'h3][2];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:137:33, :139:33]
        sink = _RANDOM[2'h3][5:3];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:137:33, :147:17]
        gotT = _RANDOM[2'h3][6];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:137:33, :148:17]
        bad_grant = _RANDOM[2'h3][7];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:137:33, :149:22]
        probes_done = _RANDOM[2'h3][8];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:137:33, :150:24]
        probes_toN = _RANDOM[2'h3][9];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:137:33, :151:23]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_schedule_bits_dir_bits_data_tag = s_release ? (_GEN_0 ? meta_tag : request_tag) : 13'h0;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/MSHR.scala:98:20, :100:17, :124:33, :215:38, :223:52, :228:53, :247:30, :272:19, :310:41]
