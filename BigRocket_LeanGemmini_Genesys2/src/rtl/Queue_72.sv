...
module Queue_72(
  ...
  input  [3:0]   io_enq_bits_sink,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  output [3:0]   io_deq_bits_sink,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  wire [148:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  ram_2x149 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[14:9];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_sink = _ram_ext_R0_data[18:15];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_denied = _ram_ext_R0_data[19];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_data = _ram_ext_R0_data[147:20];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[148];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
