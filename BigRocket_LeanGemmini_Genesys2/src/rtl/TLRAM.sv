...
module TLRAM(
  ...
  reg  [8:0]  r_source;	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:125:26]
  reg         r_read;	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:126:26]
  wire [2:0]  nodeIn_d_bits_opcode = {2'h0, r_read};	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:126:26, :196:23]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        r_full = _RANDOM[4'h5][27];	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:121:30]
        r_size = _RANDOM[4'h6][3:2];	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:124:26]
        r_source = _RANDOM[4'h6][12:4];	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:124:26, :125:26]
        r_read = _RANDOM[4'h6][13];	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:124:26, :126:26]
        REG = _RANDOM[4'h9][22];	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:308:58]
        r_0 = _RANDOM[4'h9][30:23];	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:308:58, generators/rocket-chip/src/main/scala/util/package.scala:80:63]
        r_1 = {_RANDOM[4'h9][31], _RANDOM[4'hA][6:0]};	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:308:58, generators/rocket-chip/src/main/scala/util/package.scala:80:63]
        r_2 = _RANDOM[4'hA][14:7];	// @[generators/rocket-chip/src/main/scala/util/package.scala:80:63]
        r_3 = _RANDOM[4'hA][22:15];	// @[generators/rocket-chip/src/main/scala/util/package.scala:80:63]
        r_4 = _RANDOM[4'hA][30:23];	// @[generators/rocket-chip/src/main/scala/util/package.scala:80:63]
        r_5 = {_RANDOM[4'hA][31], _RANDOM[4'hB][6:0]};	// @[generators/rocket-chip/src/main/scala/util/package.scala:80:63]
        r_6 = _RANDOM[4'hB][14:7];	// @[generators/rocket-chip/src/main/scala/util/package.scala:80:63]
        r_7 = _RANDOM[4'hB][22:15];	// @[generators/rocket-chip/src/main/scala/util/package.scala:80:63]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  TLMonitor_63 monitor (	// @[generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
    .io_in_a_ready        (nodeIn_a_ready),	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:230:49]
    ...
    .io_in_d_valid        (r_full),	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:121:30]
    .io_in_d_bits_opcode  (nodeIn_d_bits_opcode),	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:196:23]
    .io_in_d_bits_size    (r_size),	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:124:26]
    .io_in_d_bits_source  (r_source)	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:125:26]
  );
  ...
  assign auto_in_d_bits_opcode = nodeIn_d_bits_opcode;	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:196:23]
