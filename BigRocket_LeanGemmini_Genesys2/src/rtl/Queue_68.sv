...
module Queue_68(
  ...
  input  [5:0]   io_enq_bits_tl_a_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  input  [31:0]  io_enq_bits_tl_a_address,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  input  [15:0]  io_enq_bits_tl_a_mask,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  input  [127:0] io_enq_bits_tl_a_data,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  input          io_enq_bits_tl_a_corrupt,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  input  [38:0]  io_enq_bits_vaddr,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  output [5:0]   io_deq_bits_tl_a_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  output [31:0]  io_deq_bits_tl_a_address,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  output [15:0]  io_deq_bits_tl_a_mask,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  output [127:0] io_deq_bits_tl_a_data,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  output         io_deq_bits_tl_a_corrupt,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  output [38:0]  io_deq_bits_vaddr,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  reg  [336:0] ram;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[4'h0][31:1], _RANDOM[4'h1], _RANDOM[4'h2], _RANDOM[4'h3], _RANDOM[4'h4], _RANDOM[4'h5], _RANDOM[4'h6], _RANDOM[4'h7], _RANDOM[4'h8], _RANDOM[4'h9], _RANDOM[4'hA][17:0]};	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  assign io_deq_bits_tl_a_source = ram[15:10];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_tl_a_address = ram[47:16];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_tl_a_mask = ram[63:48];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_tl_a_data = ram[191:64];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_tl_a_corrupt = ram[192];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_vaddr = ram[231:193];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_debug = ram[232];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_cease = ram[233];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_wfi = ram[234];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_isa = ram[266:235];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_dprv = ram[268:267];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_dv = ram[269];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_prv = ram[271:270];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_v = ram[272];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sd = ram[273];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_zero2 = ram[296:274];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mpv = ram[297];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_gva = ram[298];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mbe = ram[299];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sbe = ram[300];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sxl = ram[302:301];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_uxl = ram[304:303];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sd_rv32 = ram[305];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_zero1 = ram[313:306];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_tsr = ram[314];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_tw = ram[315];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_tvm = ram[316];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mxr = ram[317];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sum = ram[318];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mprv = ram[319];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_xs = ram[321:320];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_fs = ram[323:322];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mpp = ram[325:324];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_vs = ram[327:326];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_spp = ram[328];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mpie = ram[329];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_ube = ram[330];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_spie = ram[331];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_upie = ram[332];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mie = ram[333];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_hie = ram[334];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sie = ram[335];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_uie = ram[336];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
