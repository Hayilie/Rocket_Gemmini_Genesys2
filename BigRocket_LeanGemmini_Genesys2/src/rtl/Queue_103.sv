...
module Queue_103(
  ...
  input  [1:0]   io_enq_bits_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  output [1:0]   io_deq_bits_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  ram_2x189 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    .W0_clk  (clock),
    .W0_data ({1'h0, io_enq_bits_data, io_enq_bits_mask, io_enq_bits_address, io_enq_bits_source, io_enq_bits_size, io_enq_bits_param, io_enq_bits_opcode})	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  );
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[11:10];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_address = _ram_ext_R0_data[43:12];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[59:44];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_data = _ram_ext_R0_data[187:60];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[188];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
