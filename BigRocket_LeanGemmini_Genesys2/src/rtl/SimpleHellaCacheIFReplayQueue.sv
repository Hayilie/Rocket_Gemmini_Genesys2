...
module SimpleHellaCacheIFReplayQueue(
  ...
  wire replay_complete = io_resp_valid & replaying & io_resp_bits_tag == 8'h0;	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:45:26, :65:{52,72}]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        replaying = _RANDOM[4'h8][14];	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:45:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_99 nackq (	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:44:21]
    .clock        (clock),
    .reset        (reset),
