...
module Queue_82(
  ...
  output         io_deq_bits_fromDMA,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                 io_count	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
);

  wire         _io_enq_ready_output;	// @[src/main/scala/chisel3/util/Decoupled.scala:304:16, :324:{24,39}]
  reg  [128:0] ram;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  always @(posedge clock) begin
    if (do_enq)	// @[src/main/scala/chisel3/util/Decoupled.scala:281:27, :316:17, :319:{26,35}]
      ram <= {io_enq_bits_fromDMA, io_enq_bits_data};	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    if (reset)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[3'h0][31:1], _RANDOM[3'h1], _RANDOM[3'h2], _RANDOM[3'h3], _RANDOM[3'h4][1:0]};	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
        full = _RANDOM[3'h0][0];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_deq_bits_data = full ? ram[127:0] : io_enq_bits_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_fromDMA = full ? ram[128] : io_enq_bits_fromDMA;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
