...
module ram_5x258(	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  input  [2:0]   R0_addr,
  input          R0_en,
                 R0_clk,
  output [257:0] R0_data,
  input  [2:0]   W0_addr,
  input          W0_en,
                 W0_clk,
  input  [257:0] W0_data
  ...
  reg [257:0] Memory[0:4];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  `ifdef ENABLE_INITIAL_MEM_	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    reg [287:0] _RANDOM_MEM;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
        for (logic [2:0] i = 3'h0; i < 3'h5; i += 3'h1) begin
          ...
          Memory[i] = _RANDOM_MEM[257:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
        end	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 258'bx;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
