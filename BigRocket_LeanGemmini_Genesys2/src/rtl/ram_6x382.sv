...
module ram_6x382(	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  input  [2:0]   R0_addr,
  input          R0_en,
                 R0_clk,
  ...
  reg [381:0] Memory[0:5];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
        for (logic [2:0] i = 3'h0; i < 3'h6; i += 3'h1) begin
          ...
          Memory[i] = _RANDOM_MEM[381:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
        end	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
      `endif // RANDOMIZE_MEM_INIT
    end // initial
