...
module ZeroWriter(
  ...
  output        io_resp_bits_mask_0,	// @[generators/gemmini/src/main/scala/gemmini/ZeroWriter.scala:32:14]
                ...
                io_resp_bits_mask_8,	// @[generators/gemmini/src/main/scala/gemmini/ZeroWriter.scala:32:14]
                io_resp_bits_mask_9,	// @[generators/gemmini/src/main/scala/gemmini/ZeroWriter.scala:32:14]
                io_resp_bits_mask_10,	// @[generators/gemmini/src/main/scala/gemmini/ZeroWriter.scala:32:14]
                io_resp_bits_mask_11,	// @[generators/gemmini/src/main/scala/gemmini/ZeroWriter.scala:32:14]
                io_resp_bits_mask_12,	// @[generators/gemmini/src/main/scala/gemmini/ZeroWriter.scala:32:14]
                io_resp_bits_mask_13,	// @[generators/gemmini/src/main/scala/gemmini/ZeroWriter.scala:32:14]
                io_resp_bits_mask_14,	// @[generators/gemmini/src/main/scala/gemmini/ZeroWriter.scala:32:14]
                io_resp_bits_mask_15,	// @[generators/gemmini/src/main/scala/gemmini/ZeroWriter.scala:32:14]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_bits_laddr_data = {_RANDOM[4'h0][31:19], _RANDOM[4'h1][0]};	// @[generators/gemmini/src/main/scala/gemmini/ZeroWriter.scala:37:16]
        req_bits_tag_cols = _RANDOM[4'h3][24:9];	// @[generators/gemmini/src/main/scala/gemmini/ZeroWriter.scala:37:16]
        req_bits_tag_pixel_repeats = {_RANDOM[4'h5][31:27], _RANDOM[4'h6][2:0]};	// @[generators/gemmini/src/main/scala/gemmini/ZeroWriter.scala:37:16]
        req_bits_tag_cmd_id = _RANDOM[4'h6][10:3];	// @[generators/gemmini/src/main/scala/gemmini/ZeroWriter.scala:37:16]
        req_bits_cols = _RANDOM[4'h9][26:20];	// @[generators/gemmini/src/main/scala/gemmini/ZeroWriter.scala:37:16]
        req_bits_block_stride = {_RANDOM[4'h9][31:27], _RANDOM[4'hA][10:0]};	// @[generators/gemmini/src/main/scala/gemmini/ZeroWriter.scala:37:16]
        col_counter = _RANDOM[4'hA][16:11];	// @[generators/gemmini/src/main/scala/gemmini/ZeroWriter.scala:37:16, :39:24]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_resp_bits_laddr_data = req_bits_laddr_data + req_bits_block_stride[13:0] * {8'h0, col_counter / 6'h10};	// @[generators/gemmini/src/main/scala/gemmini/LocalAddr.scala:51:25, generators/gemmini/src/main/scala/gemmini/ZeroWriter.scala:37:16, :39:24, :44:64, :48:20]
  ...
  assign io_resp_bits_mask_8 = {1'h0, col_counter + 6'h8} < req_bits_cols;	// @[generators/gemmini/src/main/scala/gemmini/ZeroWriter.scala:37:16, :39:24, :52:{76,82}]
  assign io_resp_bits_mask_9 = {1'h0, col_counter + 6'h9} < req_bits_cols;	// @[generators/gemmini/src/main/scala/gemmini/ZeroWriter.scala:37:16, :39:24, :52:{76,82}]
  assign io_resp_bits_mask_10 = {1'h0, col_counter + 6'hA} < req_bits_cols;	// @[generators/gemmini/src/main/scala/gemmini/ZeroWriter.scala:37:16, :39:24, :52:{76,82}]
  assign io_resp_bits_mask_11 = {1'h0, col_counter + 6'hB} < req_bits_cols;	// @[generators/gemmini/src/main/scala/gemmini/ZeroWriter.scala:37:16, :39:24, :52:{76,82}]
  assign io_resp_bits_mask_12 = {1'h0, col_counter + 6'hC} < req_bits_cols;	// @[generators/gemmini/src/main/scala/gemmini/ZeroWriter.scala:37:16, :39:24, :52:{76,82}]
  assign io_resp_bits_mask_13 = {1'h0, col_counter + 6'hD} < req_bits_cols;	// @[generators/gemmini/src/main/scala/gemmini/ZeroWriter.scala:37:16, :39:24, :52:{76,82}]
  assign io_resp_bits_mask_14 = {1'h0, col_counter + 6'hE} < req_bits_cols;	// @[generators/gemmini/src/main/scala/gemmini/ZeroWriter.scala:37:16, :39:24, :52:{76,82}]
  assign io_resp_bits_mask_15 = {1'h0, col_counter + 6'hF} < req_bits_cols;	// @[generators/gemmini/src/main/scala/gemmini/ZeroWriter.scala:37:16, :39:24, :52:{76,82}]
