...
module Queue_105(
  ...
  ram_2x60 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    .W0_clk  (clock),
    .W0_data ({17'hFFFF, io_enq_bits_address, 6'h6, io_enq_bits_param, 3'h6})	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95]
  );
  ...
  assign io_deq_bits_address = _ram_ext_R0_data[42:11];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[58:43];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[59];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
