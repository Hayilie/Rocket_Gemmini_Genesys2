...
module SinkD(
  ...
  output [3:0]  io_resp_bits_source,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14]
  ...
  input  [3:0]  io_d_bits_source,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14]
  ...
  output [3:0]  io_source,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14]
  input  [2:0]  io_way,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14]
  input  [7:0]  io_set,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14]
  ...
  output [7:0]  io_bs_adr_bits_set,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14]
  ...
  output [7:0]  io_grant_req_set,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14]
  ...
  wire [3:0]  _d_q_io_deq_bits_source;	// @[src/main/scala/chisel3/util/Decoupled.scala:376:21]
  ...
  reg  [3:0]  io_source_r;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:57:53]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_source_r = _RANDOM[/*Zero width*/ 1'b0][6:3];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:57:53, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:230:27]
        io_bs_adr_bits_beat_r = _RANDOM[/*Zero width*/ 1'b0][9:7];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:78:54, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:230:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_59 d_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:376:21]
    .clock               (clock),
    .reset               (reset),
