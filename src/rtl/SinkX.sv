...
module SinkX(
  ...
  output [14:0] io_req_bits_tag,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkX.scala:30:14]
  output [7:0]  io_req_bits_set,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkX.scala:30:14]
  ...
  Queue_60 x_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:376:21]
    .clock               (clock),
    .reset               (reset),
  ...
  assign io_req_bits_tag = {_x_q_io_deq_bits_address[31], _x_q_io_deq_bits_address[27:14]};	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:214:47, :215:22, :216:19, src/main/scala/chisel3/util/Decoupled.scala:376:21]
  assign io_req_bits_set = _x_q_io_deq_bits_address[13:6];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:215:22, :217:28, src/main/scala/chisel3/util/Decoupled.scala:376:21]
endmodule
