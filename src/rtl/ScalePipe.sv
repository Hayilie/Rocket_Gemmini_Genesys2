...
module ScalePipe(
  ...
  reg  [3:0]  io_out_pipe_b_index;	// @[src/main/scala/chisel3/util/Valid.scala:130:26]
  ...
  reg  [3:0]  io_out_pipe_pipe_b_index;	// @[src/main/scala/chisel3/util/Valid.scala:130:26]
  ...
  reg  [3:0]  io_out_pipe_pipe_pipe_b_index;	// @[src/main/scala/chisel3/util/Valid.scala:130:26]
  ...
  reg  [3:0]  io_out_pipe_pipe_pipe_pipe_b_index;	// @[src/main/scala/chisel3/util/Valid.scala:130:26]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_out_pipe_b_index = _RANDOM[3'h1][14:11];	// @[src/main/scala/chisel3/util/Valid.scala:130:26]
        io_out_pipe_pipe_v = _RANDOM[3'h1][15];	// @[src/main/scala/chisel3/util/Valid.scala:129:24, :130:26]
        io_out_pipe_pipe_b_data = _RANDOM[3'h1][23:16];	// @[src/main/scala/chisel3/util/Valid.scala:130:26]
        io_out_pipe_pipe_b_id = _RANDOM[3'h2][25:24];	// @[src/main/scala/chisel3/util/Valid.scala:130:26]
        io_out_pipe_pipe_b_index = _RANDOM[3'h2][29:26];	// @[src/main/scala/chisel3/util/Valid.scala:130:26]
        io_out_pipe_pipe_pipe_v = _RANDOM[3'h2][30];	// @[src/main/scala/chisel3/util/Valid.scala:129:24, :130:26]
        io_out_pipe_pipe_pipe_b_data = {_RANDOM[3'h2][31], _RANDOM[3'h3][6:0]};	// @[src/main/scala/chisel3/util/Valid.scala:130:26]
        io_out_pipe_pipe_pipe_b_id = _RANDOM[3'h4][8:7];	// @[src/main/scala/chisel3/util/Valid.scala:130:26]
        io_out_pipe_pipe_pipe_b_index = _RANDOM[3'h4][12:9];	// @[src/main/scala/chisel3/util/Valid.scala:130:26]
        io_out_pipe_pipe_pipe_pipe_v = _RANDOM[3'h4][13];	// @[src/main/scala/chisel3/util/Valid.scala:129:24, :130:26]
        io_out_pipe_pipe_pipe_pipe_b_data = _RANDOM[3'h4][21:14];	// @[src/main/scala/chisel3/util/Valid.scala:130:26]
        io_out_pipe_pipe_pipe_pipe_b_id = _RANDOM[3'h5][23:22];	// @[src/main/scala/chisel3/util/Valid.scala:130:26]
        io_out_pipe_pipe_pipe_pipe_b_index = _RANDOM[3'h5][27:24];	// @[src/main/scala/chisel3/util/Valid.scala:130:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
