...
module Pipeline_10(
  ...
  input  [39:0] io_in_bits_dram_addr,	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:7:14]
  ...
  output [39:0] io_out_bits_dram_addr,	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:7:14]
  ...
  reg  [39:0] stages_0_dram_addr;	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
  ...
  reg  [39:0] stages_1_dram_addr;	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        stages_0_dram_addr = {_RANDOM[5'h8][31:9], _RANDOM[5'h9][16:0]};	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_0_spad_addr = {_RANDOM[5'h9][31:17], _RANDOM[5'hA], _RANDOM[5'hB][20:0]};	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_0_I = {_RANDOM[5'hB][31:21], _RANDOM[5'hC][4:0]};	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_0_J = _RANDOM[5'hC][20:5];	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_1_cmd_inst_funct = _RANDOM[5'hC][27:21];	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_1_cmd_rs1 = {_RANDOM[5'hD][31:21], _RANDOM[5'hE], _RANDOM[5'hF][20:0]};	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_1_dram_addr = {_RANDOM[5'h14][31:30], _RANDOM[5'h15], _RANDOM[5'h16][5:0]};	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_1_spad_addr = {_RANDOM[5'h16][31:6], _RANDOM[5'h17], _RANDOM[5'h18][9:0]};	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_1_I = _RANDOM[5'h18][25:10];	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_1_J = {_RANDOM[5'h18][31:26], _RANDOM[5'h19][9:0]};	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        valids_0 = _RANDOM[5'h19][10];	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21, :22:25]
        valids_1 = _RANDOM[5'h19][11];	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21, :22:25]
      `endif // RANDOMIZE_REG_INIT
    end // initial
