...
module Queue_78(
  ...
  input  [39:0] io_enq_bits_vaddr,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  input  [10:0] io_enq_bits_laddr_garbage,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  input         io_enq_bits_laddr_garbage_bit,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  input  [13:0] io_enq_bits_laddr_data,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  output [39:0] io_deq_bits_vaddr,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  output [10:0] io_deq_bits_laddr_garbage,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  output        io_deq_bits_laddr_garbage_bit,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  output [13:0] io_deq_bits_laddr_data,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  wire [381:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  ram_6x382 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  assign io_deq_bits_vaddr = _ram_ext_R0_data[39:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_laddr_is_acc_addr = _ram_ext_R0_data[40];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_laddr_accumulate = _ram_ext_R0_data[41];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_laddr_read_full_acc_row = _ram_ext_R0_data[42];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_laddr_norm_cmd = _ram_ext_R0_data[45:43];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_laddr_garbage = _ram_ext_R0_data[56:46];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_laddr_garbage_bit = _ram_ext_R0_data[57];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_laddr_data = _ram_ext_R0_data[71:58];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_acc_act = _ram_ext_R0_data[74:72];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_acc_scale = _ram_ext_R0_data[106:75];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_acc_igelu_qb = _ram_ext_R0_data[138:107];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_acc_igelu_qc = _ram_ext_R0_data[170:139];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_acc_iexp_qln2 = _ram_ext_R0_data[202:171];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_acc_iexp_qln2_inv = _ram_ext_R0_data[234:203];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_acc_norm_stats_id = _ram_ext_R0_data[242:235];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_len = _ram_ext_R0_data[258:243];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_block = _ram_ext_R0_data[266:259];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_cmd_id = _ram_ext_R0_data[274:267];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_debug = _ram_ext_R0_data[275];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_cease = _ram_ext_R0_data[276];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_wfi = _ram_ext_R0_data[277];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_isa = _ram_ext_R0_data[309:278];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_dprv = _ram_ext_R0_data[311:310];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_dv = _ram_ext_R0_data[312];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_prv = _ram_ext_R0_data[314:313];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_v = _ram_ext_R0_data[315];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sd = _ram_ext_R0_data[316];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_zero2 = _ram_ext_R0_data[339:317];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mpv = _ram_ext_R0_data[340];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_gva = _ram_ext_R0_data[341];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mbe = _ram_ext_R0_data[342];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sbe = _ram_ext_R0_data[343];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sxl = _ram_ext_R0_data[345:344];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_uxl = _ram_ext_R0_data[347:346];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sd_rv32 = _ram_ext_R0_data[348];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_zero1 = _ram_ext_R0_data[356:349];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_tsr = _ram_ext_R0_data[357];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_tw = _ram_ext_R0_data[358];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_tvm = _ram_ext_R0_data[359];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mxr = _ram_ext_R0_data[360];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sum = _ram_ext_R0_data[361];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mprv = _ram_ext_R0_data[362];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_xs = _ram_ext_R0_data[364:363];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_fs = _ram_ext_R0_data[366:365];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mpp = _ram_ext_R0_data[368:367];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_vs = _ram_ext_R0_data[370:369];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_spp = _ram_ext_R0_data[371];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mpie = _ram_ext_R0_data[372];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_ube = _ram_ext_R0_data[373];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_spie = _ram_ext_R0_data[374];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_upie = _ram_ext_R0_data[375];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mie = _ram_ext_R0_data[376];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_hie = _ram_ext_R0_data[377];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sie = _ram_ext_R0_data[378];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_uie = _ram_ext_R0_data[379];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_pool_en = _ram_ext_R0_data[380];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_store_en = _ram_ext_R0_data[381];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
