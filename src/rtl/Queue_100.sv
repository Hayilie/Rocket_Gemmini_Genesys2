...
module Queue_100(
  ...
  input  [4:0]  io_enq_bits_rd,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  output [4:0]  io_deq_bits_rd,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  output [63:0] io_deq_bits_data	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
);

  wire [68:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  ram_2x69 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_data, io_enq_bits_rd})	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  );
  ...
  assign io_deq_bits_rd = _ram_ext_R0_data[4:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_data = _ram_ext_R0_data[68:5];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
