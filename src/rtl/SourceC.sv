...
module SourceC(
  ...
  input  [3:0]  io_req_bits_source,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:37:14]
  input  [14:0] io_req_bits_tag,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:37:14]
  input  [7:0]  io_req_bits_set,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:37:14]
  ...
  output [2:0]  io_c_bits_opcode,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:37:14]
                io_c_bits_param,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:37:14]
                io_c_bits_size,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:37:14]
  output [3:0]  io_c_bits_source,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:37:14]
  ...
  output [7:0]  io_bs_adr_bits_set,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:37:14]
  ...
  output [7:0]  io_evict_req_set,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:37:14]
  ...
  reg  [3:0]  req_r_source;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47]
  reg  [14:0] req_r_tag;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47]
  reg  [7:0]  req_r_set;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47]
  reg  [2:0]  req_r_way;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47]
  wire [7:0]  req_set = busy ? req_r_set : io_req_bits_set;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:66:21, :69:{17,47}]
  ...
  reg  [3:0]  s2_req_source;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25]
  reg  [14:0] s2_req_tag;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25]
  reg  [7:0]  s2_req_set;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25]
  ...
  reg  [3:0]  s3_req_source;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:104:25]
  reg  [14:0] s3_req_tag;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:104:25]
  reg  [7:0]  s3_req_set;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:104:25]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_r_source = _RANDOM[2'h0][18:15];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:58:21, :69:47]
        req_r_tag = {_RANDOM[2'h0][31:19], _RANDOM[2'h1][1:0]};	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:58:21, :69:47]
        req_r_set = _RANDOM[2'h1][9:2];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47]
        req_r_way = _RANDOM[2'h1][12:10];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47]
        s2_valid = _RANDOM[2'h1][14];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47, :97:25]
        s2_req_opcode = _RANDOM[2'h1][17:15];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47, :98:25]
        s2_req_param = _RANDOM[2'h1][20:18];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47, :98:25]
        s2_req_source = _RANDOM[2'h1][24:21];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47, :98:25]
        s2_req_tag = {_RANDOM[2'h1][31:25], _RANDOM[2'h2][7:0]};	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47, :98:25]
        s2_req_set = _RANDOM[2'h2][15:8];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25]
        s3_valid = _RANDOM[2'h2][24];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25, :103:25]
        s3_req_opcode = _RANDOM[2'h2][27:25];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25, :104:25]
        s3_req_param = _RANDOM[2'h2][30:28];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25, :104:25]
        s3_req_source = {_RANDOM[2'h2][31], _RANDOM[2'h3][2:0]};	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25, :104:25]
        s3_req_tag = _RANDOM[2'h3][17:3];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:104:25]
        s3_req_set = _RANDOM[2'h3][25:18];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:104:25]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_53 queue (	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:54:21]
    .clock               (clock),
    .reset               (reset),
    ...
    .io_enq_bits_address ({s3_req_tag[14], 3'h0, s3_req_tag[13:0], s3_req_set, 6'h0}),	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:221:15, :229:72, :230:8, generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:104:25]
