...
module LoopConvLdWeight(
  ...
  wire [16:0] _next_kch_T_3 = {1'h0, kch} + {1'h0, req_trans_weight_0132 ? max_chs_per_mvin_max_kchs_per_mvin : 16'h10};	// @[generators/gemmini/src/main/scala/gemmini/LoopConv.scala:435:22, :437:16, :445:32, :463:16, :475:23, :480:14, :552:23, generators/gemmini/src/main/scala/gemmini/Util.scala:41:15]
  ...
  wire [16:0] _next_och_T_8 = {1'h0, och} + {1'h0, req_trans_weight_0132 ? 16'h10 : max_chs_per_mvin_max_ochs_per_mvin};	// @[generators/gemmini/src/main/scala/gemmini/LoopConv.scala:435:22, :437:16, :444:32, :460:16, :475:23, :481:14, :551:23, generators/gemmini/src/main/scala/gemmini/Util.scala:41:15]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_addr_end = {_RANDOM[5'h17][31:18], _RANDOM[5'h18][0]};	// @[generators/gemmini/src/main/scala/gemmini/LoopConv.scala:437:16]
        req_dram_addr = {_RANDOM[5'h18][31:1], _RANDOM[5'h19][8:0]};	// @[generators/gemmini/src/main/scala/gemmini/LoopConv.scala:437:16]
        req_trans_weight_1203 = _RANDOM[5'h19][9];	// @[generators/gemmini/src/main/scala/gemmini/LoopConv.scala:437:16]
        req_trans_weight_0132 = _RANDOM[5'h19][10];	// @[generators/gemmini/src/main/scala/gemmini/LoopConv.scala:437:16]
        req_dw = _RANDOM[5'h19][11];	// @[generators/gemmini/src/main/scala/gemmini/LoopConv.scala:437:16]
        req_loop_id = _RANDOM[5'h19][12];	// @[generators/gemmini/src/main/scala/gemmini/LoopConv.scala:437:16]
        och = _RANDOM[5'h19][28:13];	// @[generators/gemmini/src/main/scala/gemmini/LoopConv.scala:437:16, :460:16]
        krow = {_RANDOM[5'h19][31:29], _RANDOM[5'h1A][12:0]};	// @[generators/gemmini/src/main/scala/gemmini/LoopConv.scala:437:16, :461:17]
        kcol = _RANDOM[5'h1A][28:13];	// @[generators/gemmini/src/main/scala/gemmini/LoopConv.scala:461:17, :462:17]
        kch = {_RANDOM[5'h1A][31:29], _RANDOM[5'h1B][12:0]};	// @[generators/gemmini/src/main/scala/gemmini/LoopConv.scala:461:17, :463:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Pipeline_12 command_p (	// @[generators/gemmini/src/main/scala/gemmini/LoopConv.scala:493:25]
    ...
    .io_in_bits_dram_addr       ({27'h0, {9'h0, req_dw ? _dram_offset_T_19 + _GEN_6 : req_trans_weight_1203 ? (_GEN_7 * _GEN_3 * _GEN_3 + _dram_offset_T_19 + _GEN_6) * _GEN_9 + _GEN_8 : req_trans_weight_0132 ? (_dram_offset_T_19 * _GEN_9 + _GEN_6 * _GEN_9 + _GEN_8) * _GEN_5 + _GEN_7 : (_dram_offset_T_19 * _GEN_5 + _GEN_6 * _GEN_5 + _GEN_7) * {16'h0, req_outer_bounds_weight_stride} + _GEN_8} + {1'h0, req_dram_addr}}),	// @[generators/gemmini/src/main/scala/gemmini/LoopConv.scala:435:22, :437:16, :455:42, :466:{35,46,66,79,87,103}, :467:34, :468:{47,78,87,102}, :469:{48,69,83,91,105}, :471:33, :537:18, :1556:17, src/main/scala/chisel3/util/Mux.scala:141:16]
    .io_in_bits_spad_addr       (req_trans_weight_0132 ? _addr_start_T + {16'h0, {16'h0, {16'h0, kch / 16'h10} * _GEN_10} * _GEN_11} * _GEN_1 + {16'h0, _GEN_12 * {32'h0, req_derived_params_ochs}} + {32'h0, _GEN_6 * {16'h0, req_derived_params_ochs}} + {48'h0, och} : _addr_start_T + {16'h0, {16'h0, {16'h0, och / 16'h10} * _GEN_10} * _GEN_11} * _GEN_2 + {16'h0, _GEN_12 * {32'h0, req_inner_bounds_kchs}} + {32'h0, _GEN_6 * {16'h0, req_inner_bounds_kchs}} + {48'h0, kch}),	// @[generators/gemmini/src/main/scala/gemmini/LoopConv.scala:437:16, :449:{72,80}, :450:43, :451:33, :460:16, :463:16, :466:66, :473:22, :475:{23,55,63,71,78,93,100,107,114}, :476:{23,55,63,71,78,93,100,107,114}, src/main/scala/chisel3/util/Mux.scala:141:16]
    .io_in_bits_K               (req_trans_weight_0132 ? (_K_T_3 > 16'h10 ? 16'h10 : _K_T_3) : _K_T_9 > 16'h10 ? 16'h10 : _K_T_9),	// @[generators/gemmini/src/main/scala/gemmini/LoopConv.scala:437:16, :475:23, :480:14, :481:14, :482:14, :483:{8,20}, :484:{8,20}]
