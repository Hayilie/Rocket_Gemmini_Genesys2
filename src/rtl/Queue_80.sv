...
module Queue_80(
  ...
  wire [188:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  ram_5x189 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  assign io_deq_bits_laddr_garbage_bit = _ram_ext_R0_data[43];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_laddr_data = _ram_ext_R0_data[57:44];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_len = _ram_ext_R0_data[73:58];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_block = _ram_ext_R0_data[81:74];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_debug = _ram_ext_R0_data[82];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_cease = _ram_ext_R0_data[83];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_wfi = _ram_ext_R0_data[84];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_isa = _ram_ext_R0_data[116:85];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_dprv = _ram_ext_R0_data[118:117];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_dv = _ram_ext_R0_data[119];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_prv = _ram_ext_R0_data[121:120];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_v = _ram_ext_R0_data[122];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sd = _ram_ext_R0_data[123];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_zero2 = _ram_ext_R0_data[146:124];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mpv = _ram_ext_R0_data[147];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_gva = _ram_ext_R0_data[148];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mbe = _ram_ext_R0_data[149];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sbe = _ram_ext_R0_data[150];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sxl = _ram_ext_R0_data[152:151];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_uxl = _ram_ext_R0_data[154:153];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sd_rv32 = _ram_ext_R0_data[155];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_zero1 = _ram_ext_R0_data[163:156];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_tsr = _ram_ext_R0_data[164];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_tw = _ram_ext_R0_data[165];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_tvm = _ram_ext_R0_data[166];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mxr = _ram_ext_R0_data[167];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sum = _ram_ext_R0_data[168];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mprv = _ram_ext_R0_data[169];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_xs = _ram_ext_R0_data[171:170];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_fs = _ram_ext_R0_data[173:172];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mpp = _ram_ext_R0_data[175:174];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_vs = _ram_ext_R0_data[177:176];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_spp = _ram_ext_R0_data[178];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mpie = _ram_ext_R0_data[179];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_ube = _ram_ext_R0_data[180];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_spie = _ram_ext_R0_data[181];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_upie = _ram_ext_R0_data[182];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mie = _ram_ext_R0_data[183];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_hie = _ram_ext_R0_data[184];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sie = _ram_ext_R0_data[185];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_uie = _ram_ext_R0_data[186];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_pool_en = _ram_ext_R0_data[187];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_store_en = _ram_ext_R0_data[188];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
