...
module Pipeline_1(
  ...
  input  [127:0] io_in_bits_data,	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:7:14]
  ...
  output [127:0] io_out_bits_data,	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:7:14]
  ...
  reg  [127:0] stages_0_data;	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
  reg          stages_0_fromDMA;	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
  reg  [127:0] stages_1_data;	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
  reg          stages_1_fromDMA;	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
  reg  [127:0] stages_2_data;	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
  reg          stages_2_fromDMA;	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
  reg  [127:0] stages_3_data;	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        stages_0_data = {_RANDOM[5'h0], _RANDOM[5'h1], _RANDOM[5'h2], _RANDOM[5'h3]};	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_0_fromDMA = _RANDOM[5'h4][0];	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_1_data = {_RANDOM[5'h4][31:1], _RANDOM[5'h5], _RANDOM[5'h6], _RANDOM[5'h7], _RANDOM[5'h8][0]};	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_1_fromDMA = _RANDOM[5'h8][1];	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_2_data = {_RANDOM[5'h8][31:2], _RANDOM[5'h9], _RANDOM[5'hA], _RANDOM[5'hB], _RANDOM[5'hC][1:0]};	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_2_fromDMA = _RANDOM[5'hC][2];	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_3_data = {_RANDOM[5'hC][31:3], _RANDOM[5'hD], _RANDOM[5'hE], _RANDOM[5'hF], _RANDOM[5'h10][2:0]};	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_3_fromDMA = _RANDOM[5'h10][3];	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        valids_0 = _RANDOM[5'h10][4];	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21, :22:25]
        valids_1 = _RANDOM[5'h10][5];	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21, :22:25]
        valids_2 = _RANDOM[5'h10][6];	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21, :22:25]
        valids_3 = _RANDOM[5'h10][7];	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21, :22:25]
      `endif // RANDOMIZE_REG_INIT
    end // initial
