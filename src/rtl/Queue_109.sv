...
module Queue_109(
  ...
  input  [7:0] io_enq_bits,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  output [7:0] io_deq_bits,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  output [8:0] io_count	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        enq_ptr_value = _RANDOM[/*Zero width*/ 1'b0][7:0];	// @[src/main/scala/chisel3/util/Counter.scala:61:40]
        deq_ptr_value = _RANDOM[/*Zero width*/ 1'b0][15:8];	// @[src/main/scala/chisel3/util/Counter.scala:61:40]
        maybe_full = _RANDOM[/*Zero width*/ 1'b0][16];	// @[src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Decoupled.scala:277:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ram_256x8 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
