...
module LoopMatmulExecute(
  ...
  wire [24:0] _GEN = {9'h0, req_max_j};	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:384:16, :387:49, :401:54]
  ...
  wire [28:0] _a_addr_T_4 = {15'h0, req_a_addr_start} + {{9'h0, req_a_tranpose ? k : i} * {9'h0, req_a_tranpose ? req_max_i : req_max_k} + {9'h0, req_a_tranpose ? i : k}, 4'h0};	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:384:16, :389:14, :391:14, :393:18, :394:18, :398:22, :401:{33,42,54}, :405:34]
  wire [28:0] _b_addr_T_4 = {14'h0, req_b_addr_end} - {{9'h0, req_max_k} * _GEN, 4'h0} + {{9'h0, req_b_tranpose ? j : k} * {9'h0, req_b_tranpose ? req_max_k : req_max_j} + {9'h0, req_b_tranpose ? k : j}, 4'h0};	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:384:16, :387:{37,49}, :389:14, :390:14, :395:18, :396:18, :399:22, :401:54, :402:{29,38,50}, :405:34]
  wire [28:0] _c_addr_T_4 = {19'h0, req_c_addr_start} + {{9'h0, i} * _GEN + {9'h0, j}, 4'h0};	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:384:16, :387:49, :390:14, :391:14, :401:54, :403:{29,34,46}, :405:34]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_pad_j = _RANDOM[3'h1][21:18];	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:384:16]
        req_pad_k = _RANDOM[3'h1][25:22];	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:384:16]
        req_pad_i = _RANDOM[3'h1][29:26];	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:384:16]
        req_a_tranpose = _RANDOM[3'h1][30];	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:384:16]
        req_b_tranpose = _RANDOM[3'h1][31];	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:384:16]
        req_accumulate = _RANDOM[3'h2][0];	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:384:16]
        req_a_addr_start = _RANDOM[3'h2][14:1];	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:384:16]
        req_b_addr_end = _RANDOM[3'h2][29:15];	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:384:16]
        req_c_addr_start = {_RANDOM[3'h2][31:30], _RANDOM[3'h3][7:0]};	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:384:16]
        req_loop_id = _RANDOM[3'h3][8];	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:384:16]
        req_skip = _RANDOM[3'h3][9];	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:384:16]
        k = _RANDOM[3'h3][25:10];	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:384:16, :389:14]
        j = {_RANDOM[3'h3][31:26], _RANDOM[3'h4][9:0]};	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:384:16, :390:14]
        i = _RANDOM[3'h4][25:10];	// @[generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:390:14, :391:14]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_cmd_bits_rs1 = {11'h0, _io_cmd_bits_T ? {5'h10 - {1'h0, k == _next_k_max_T ? req_pad_k : 4'h0}, 11'h0, 5'h10 - {1'h0, j == _next_j_max_T ? req_pad_j : 4'h0}, {3{|i}}, (|i) ? 3'h0 : _b_addr_T_4[28:26], 11'h0, (|i) | _b_addr_T_4[14], (|i) ? 14'h3FFF : _b_addr_T_4[13:0]} : {5'h10 - {1'h0, i == _next_i_max_T ? req_pad_i : 4'h0}, 11'h0, 5'h10 - {1'h0, k == _next_k_max_T ? req_pad_k : 4'h0}, 3'h0, _a_addr_T_4[28:26], 11'h0, _a_addr_T_4[14:0]}};	// @[generators/gemmini/src/main/scala/gemmini/LocalAddr.scala:99:13, :108:37, generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:382:22, :384:16, :389:14, :390:14, :391:14, :401:33, :402:29, :405:{29,34,37,51}, :406:{29,34,37,51}, :407:{29,34,37,51}, :408:{29,34,37}, :417:15, :420:{32,35}, :429:30, :448:32, :464:{21,28}]
  assign io_cmd_bits_rs2 = _io_cmd_bits_T ? {11'h0, 5'h10 - {1'h0, i == _next_i_max_T ? req_pad_i : 4'h0}, 11'h0, 5'h10 - {1'h0, j == _next_j_max_T ? req_pad_j : 4'h0}, 1'h1, req_accumulate | (|k), 1'h0, _c_addr_T_4[28:26], 11'h0, _c_addr_T_4[14:0]} : 64'h100010E0007FFF;	// @[generators/gemmini/src/main/scala/gemmini/LocalAddr.scala:108:37, generators/gemmini/src/main/scala/gemmini/LoopMatmul.scala:382:22, :384:16, :389:14, :390:14, :391:14, :403:29, :405:{29,34,51}, :406:51, :407:51, :409:{29,34,37}, :410:{29,34,37}, :417:15, :427:{106,111}, :430:30, :449:32, :464:{21,28}]
