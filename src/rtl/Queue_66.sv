...
module Queue_66(
  ...
  input  [4:0]   io_enq_bits_tl_a_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  output [4:0]   io_deq_bits_tl_a_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  reg  [335:0] ram;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[4'h0][31:1], _RANDOM[4'h1], _RANDOM[4'h2], _RANDOM[4'h3], _RANDOM[4'h4], _RANDOM[4'h5], _RANDOM[4'h6], _RANDOM[4'h7], _RANDOM[4'h8], _RANDOM[4'h9], _RANDOM[4'hA][16:0]};	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  assign io_deq_bits_tl_a_source = ram[14:10];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_tl_a_address = ram[46:15];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_tl_a_mask = ram[62:47];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_tl_a_data = ram[190:63];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_tl_a_corrupt = ram[191];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_vaddr = ram[230:192];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_debug = ram[231];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_cease = ram[232];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_wfi = ram[233];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_isa = ram[265:234];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_dprv = ram[267:266];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_dv = ram[268];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_prv = ram[270:269];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_v = ram[271];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sd = ram[272];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_zero2 = ram[295:273];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mpv = ram[296];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_gva = ram[297];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mbe = ram[298];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sbe = ram[299];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sxl = ram[301:300];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_uxl = ram[303:302];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sd_rv32 = ram[304];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_zero1 = ram[312:305];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_tsr = ram[313];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_tw = ram[314];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_tvm = ram[315];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mxr = ram[316];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sum = ram[317];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mprv = ram[318];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_xs = ram[320:319];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_fs = ram[322:321];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mpp = ram[324:323];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_vs = ram[326:325];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_spp = ram[327];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mpie = ram[328];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_ube = ram[329];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_spie = ram[330];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_upie = ram[331];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mie = ram[332];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_hie = ram[333];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sie = ram[334];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_uie = ram[335];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
