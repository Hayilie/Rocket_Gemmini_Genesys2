...
module MulAddRecFNPipe_1(
  ...
  MulAddRecFNToRaw_preMul_21 mulAddRecFNToRaw_preMul (	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:646:41]
    .io_op                        (io_op),
    .io_a                         (io_a),
    .io_b                         (io_b),
    .io_c                         (io_c),
  ...
  MulAddRecFNToRaw_postMul_21 mulAddRecFNToRaw_postMul (	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:647:42]
  ...
  RoundRawFNToRecFN_21 roundRawFNToRecFN (	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:674:35]
