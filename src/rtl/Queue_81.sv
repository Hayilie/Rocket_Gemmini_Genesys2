...
module Queue_81(
  ...
  wire [257:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  ram_5x258 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  assign io_deq_bits_laddr_data = _ram_ext_R0_data[55:42];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_cols = _ram_ext_R0_data[71:56];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_repeats = _ram_ext_R0_data[87:72];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_scale = _ram_ext_R0_data[119:88];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_has_acc_bitwidth = _ram_ext_R0_data[120];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_block_stride = _ram_ext_R0_data[136:121];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_pixel_repeats = _ram_ext_R0_data[144:137];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_cmd_id = _ram_ext_R0_data[152:145];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_debug = _ram_ext_R0_data[153];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_cease = _ram_ext_R0_data[154];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_wfi = _ram_ext_R0_data[155];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_isa = _ram_ext_R0_data[187:156];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_dprv = _ram_ext_R0_data[189:188];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_dv = _ram_ext_R0_data[190];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_prv = _ram_ext_R0_data[192:191];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_v = _ram_ext_R0_data[193];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sd = _ram_ext_R0_data[194];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_zero2 = _ram_ext_R0_data[217:195];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mpv = _ram_ext_R0_data[218];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_gva = _ram_ext_R0_data[219];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mbe = _ram_ext_R0_data[220];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sbe = _ram_ext_R0_data[221];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sxl = _ram_ext_R0_data[223:222];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_uxl = _ram_ext_R0_data[225:224];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sd_rv32 = _ram_ext_R0_data[226];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_zero1 = _ram_ext_R0_data[234:227];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_tsr = _ram_ext_R0_data[235];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_tw = _ram_ext_R0_data[236];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_tvm = _ram_ext_R0_data[237];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mxr = _ram_ext_R0_data[238];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sum = _ram_ext_R0_data[239];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mprv = _ram_ext_R0_data[240];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_xs = _ram_ext_R0_data[242:241];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_fs = _ram_ext_R0_data[244:243];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mpp = _ram_ext_R0_data[246:245];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_vs = _ram_ext_R0_data[248:247];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_spp = _ram_ext_R0_data[249];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mpie = _ram_ext_R0_data[250];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_ube = _ram_ext_R0_data[251];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_spie = _ram_ext_R0_data[252];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_upie = _ram_ext_R0_data[253];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_mie = _ram_ext_R0_data[254];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_hie = _ram_ext_R0_data[255];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_sie = _ram_ext_R0_data[256];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_status_uie = _ram_ext_R0_data[257];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
